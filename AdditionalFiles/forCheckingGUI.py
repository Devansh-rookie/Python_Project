...
labelHeadName.grid(row=0, column=0, columnspan=3, padx=40)
labelRollName.grid(row=0, column=4,  columnspan=3, padx=40)
labelPathImgName.grid(row=0, column=7, columnspan=3, padx=40)
FrameHead.grid(row=0, column=0, sticky="w")
i=1
if(len(data_listed)==0):
    labelHeadName = Label(master=window, text="No Students")
    labelHeadName.grid(row=i, column=0)
    i+=1
else:
    for data_row in data_listed:
        ...
        labelRollName.grid(row=0, column=4,  columnspan=3, padx=40)
        labelPathImgName.grid(row=0, column=7, columnspan=3, padx=40)
        FrameHead.grid(row=i, column=0, sticky="w")
        i+=1
